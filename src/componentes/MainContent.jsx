...
function MainContent() {
  ...
  const images = [
    "/img/06-tienda/tienda1-a.png",
    "/img/06-tienda/tienda2-a.png",
    "/img/06-tienda/tienda3-a.png",
  ];
      ...
      <section className="offersSection">
        ...
        <div className="offersGrid">
          <div className="offerItem">
            <img src="/img/06-tienda/tienda9-a.png" alt="Producto Usado 1" className="offerImage" />
          ...
          <div className="offerItem">
            <img src="/img/06-tienda/tienda10-a.png" alt="Producto Usado 2" className="offerImage" />
      ...
      <section className="newArrivalsSection">
        ...
        <div className="productsGrid">
          <div className="productItem">
            <img src="/img/06-tienda/tienda11-a.png" alt="Producto Usado 3" className="productImage" />
          ...
          <div className="productItem">
            <img src="/img/06-tienda/tienda13-a.png" alt="Producto Usado 4" className="productImage" />
          ...
          <div className="productItem">
            <img src="/img/06-tienda/tienda14-a.png" alt="Producto Usado 5" className="productImage" />
